...
<div class="bg-[#323231] rounded-lg p-8 shadow-lg max-w-sm w-full">
        ...
        <form class="space-y-4 text-[#fff] max-w-md mx-auto" action="index.php?controller=users&amp;action=login" method="POST">
        ...
        <div class="mt-4 ">
            <a href="index.php?controller=users&amp;action=register" class="text-yellow-400 hover:text-yellow-500 text-sm underline"><?= i18n("Register here!")?></a>
        </div>
    </div>
