  ...
  [&::-webkit-scrollbar-thumb]:rounded-full">
        ...
        <?php foreach ($projects as $project): ?>
            ...
            <div class="flex justify-between items-center bg-[#3d3d3d] p-4 rounded text-white">
                <a href="index.php?controller=project&amp;action=view&amp;idProject=<?= $project->getIdProject() ?>">
                    <div class="flex items-center space-x-2">
                        <i class="fa-regular fa-folder-open text-<?= $project->getTheme() ?>"></i>
                        <span><?= $project->getProjectName() ?></span>
                    </div>
                </a>
                <?php $modalId = "modal-" . $project->getIdProject(); ?>
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-[#323231]">
                        ...
                        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                            ...
                            <form id="deleteProject" class="text-white" method="POST"
                                action="index.php?controller=project&amp;action=delete">
                                <input type="text" name="idProject" value="<?= $project->getIdProject() ?>" hidden>
                                <button type="submit"
            ...
            <div class="relative bg-[#323231] rounded-lg shadow">
                ...
                <div class="p-4">
                    <form id="addProjectForm" class="text-white" method="POST"
                        action="index.php?controller=project&amp;action=add">
                        ...
                        <div class="flex flex-wrap mb-4">
                            <label class="flex items-center me-4 relative">
                                <input id="orange-radio" type="radio" name="theme" value="orange-300"
                            ...
                            <label class="flex items-center me-4 relative">
                                <input id="red-radio" type="radio" name="theme" value="red-500"
                                    class="hidden peer" required />
                                <div
                            ...
                            <label class="flex items-center me-4 relative">
                                <input id="green-radio" type="radio" name="theme" value="green-400"
                                    class="hidden peer" required />
                                <div
                            ...
                            <label class="flex items-center me-4 relative">
                                <input checked id="purple-radio" type="radio" name="theme" value="purple-400"
                                    class="hidden peer" required />
                                <div
                            ...
                            <label class="flex items-center me-4 relative">
                                <input id="cyan-radio" type="radio" name="theme" value="cyan-500"
                                    class="hidden peer" required />
                                <div
                            ...
                            <label class="flex items-center me-4 relative">
                                <input id="yellow-radio" type="radio" name="theme" value="yellow-400"
                                    class="hidden peer" required />
                                <div
                            ...
                            <label class="flex items-center me-4 relative">
                                <input id="black-radio" type="radio" name="theme" value="black"
                                    class="hidden peer" required />
                                <div
